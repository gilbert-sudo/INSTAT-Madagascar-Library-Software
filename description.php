...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          if (isset($_SESSION['user'])) {
            echo '
                    <li><a href="cart.php" class="btn btn-md"><span class="glyphicon glyphicon-star">Favoris</span></a></li>
                    <li><a href="destroy.php" class="btn btn-md"> <span class="glyphicon glyphicon-log-out">Déconnecter</span></a></li>
                         ';
          }
          ?>
        </ul>
  ...
  <div class="container-fluid" id="books">
    <div class="row">
      ...
      if (isset($_GET['pdf'])) {
        echo '                           <br><br><br>
                                <a onclick="NewTab();" id="buyLink" href="#" class="btn btn-lg btn-danger" style="min-width: 100px; padding:15px;color:white;text-decoration:none;"> 
                                    Lire<br>
                                     <script>
                                            function NewTab() {
                                                window.open("read.php?name=' . $_GET['pdf'] . '.pdf",
